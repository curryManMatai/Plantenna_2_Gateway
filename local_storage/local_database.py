...
def insert_data(temp, humidity, batV, airflow, pressure,nodeID):
    sql = "INSERT INTO Sensor_data(temperature, humidity, battery_voltage, airflow, pressure, nodeID) " \
            "VALUES(%s,%s,%s,%s,%s,%s)"
    val = (temp, humidity, batV, airflow, pressure, nodeID)
